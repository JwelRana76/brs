          ...
          <div class="card p-3">
            <div class="row">
              <div class="col-md-4 m-auto">
                <x-input id="khotian_no" label="খতিয়ান নং"  />
              </div>
              <div class="col-md-12">
                <hr>
              </div>
              <div class="col-md-2">
                <x-select id="division" label="বিভাগ" name="division_id" :options="$divisions" />
              </div>
              <div class="col-md-2">
                <x-select id="district" label="জেলা" name="district_id" :options="$districts" />
              </div>
              <div class="col-md-2">
                <x-select id="upazila" label="থানা" name="upazila_id" :options="$upazilas" />
              </div>
              <div class="col-md-2">
                <x-select id="mouja" label="মৌজা" name="mouja_id" :options="$moujas" />
              </div>
              <div class="col-md-2">
                <x-select id="jlno" label="জেএল নং" name="jlno_id" :options="$jlnos" />
              </div>
              <div class="col-md-2">
                <x-input id="name" label="রেঃসাঃনং" />
              </div>
              <div class="col-md-12">
                <hr>
              </div>
                ...
                <table class="table table-bordered brs-table" style="font-size:12px">
                    ...
                    <tbody id="test_table">
                      <tr>
                        ...
                        <td>
                          <x-select2 id="plottype" name="plottype[]" :options="$krisis" />
                        </td>
                        <td>
                          <x-select2 id="plottype2" name="plottype2[]" :options="$okrisis" />
                        </td>
                        <td>
        ...
        $('#brs_added_button').on('click', function () {
          $('#test_table').append(`
            <tr>
              ...
              <td>
                <x-input2 name="revenue" />
              </td>
              <td>
                <x-input2 name="stain" />
              </td>
              <td>
                <x-input2 name="plottype1" />
              </td>
              <td>
                <x-input2 name="plottype2" />
              </td>
              <td>
                <x-input2 name="amount1" />
              </td>
              <td>
                <x-input2 name="amount2" />
              </td>
              <td>
                <x-input2 name="khotian_amount" />
              </td>
              <td>
                <x-input2 name="plot_amount1" />
              </td>
              <td>
                <x-input2 name="plot_amount2 " />
              </td>
              <td>
                <x-textarea2 id="comment" />
              </td>
            </tr>
          `);
        });
